app.controller("car_indemnity_loan_statistics_controller", ["$scope", "$host", "_basic", function ($scope, $host, _basic) {
    ...
    $scope.getLoanMonthInfo = function () {
        ...
        _basic.get($host.api_url + "/damageInsureLoanMonthStat?monthStart=" + monthStart + "&monthEnd=" + monthEnd).then(function (data) {
