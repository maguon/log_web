...
app.config(['$stateProvider',"$urlRouterProvider",function($stateProvider,$urlRouterProvider) {
    $urlRouterProvider.when("","/audit_index");
    $stateProvider
        // 指令调度
        .state("audit_index", {  //路由状态
            url: "/audit_index",  //路由路径
            templateUrl: "/js/view/audit/audit_index.html",  //路由填充的模板
            controller: 'audit_index_controller'
        })
